...
<body style="background: #f9fafb; font-family: system-ui, sans-serif; margin: 0; padding: 0;">

<div style="max-width: 1300px; margin: 40px auto; padding: 0 20px;">
    
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <div>
            <h1 style="color: #1f2937; margin: 0;">📦 Auditoría de Pedidos</h1>
            <p style="color: #6b7280; margin: 5px 0 0 0;">Monitorea los flujos de entrega, direcciones de envío y estados de pago.</p>
        </div>
        <a href="/admin" style="text-decoration: none; background: #4f8cff; color: white; padding: 10px 15px; border-radius: 6px; font-weight: bold;">
    ...
    <form action="{{ url('/admin/pedidos') }}" method="GET" style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #e5e7eb; display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-end; margin-bottom: 25px;">
        ...
        <div style="flex: 2; min-width: 250px; display: flex; flex-direction: column; gap: 6px;">
            <label style="font-weight: bold; font-size: 13px; color: #4b5563;">Buscar Cliente / Destino:</label>
        ...
        <div style="flex: 1; min-width: 180px; display: flex; flex-direction: column; gap: 6px;">
            <label style="font-weight: bold; font-size: 13px; color: #4b5563;">Estado de Pasarela:</label>
        ...
        <table class="tabla-pedidos">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $pedido->created_at->format('d/m/Y h:i A') }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
